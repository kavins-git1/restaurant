...
import com.kvn.Restaurent.request.IngredientCategoryRequest;
import com.kvn.Restaurent.request.IngredientRequest;
import com.kvn.Restaurent.service.IngredientsService;
...
public class IngredientController {
    ...
    @PutMapping("/{id}/stoke")
    public ResponseEntity<IngredientItem> updateIngredientsStock(
    ...
    public ResponseEntity<List<IngredientItem>> getRestaurantIngredient(
        ...
        List<IngredientItem> items=ingredientsService.findRestaurantsIngredient(id);
